...
export default function AppItemOrders() {
  ...
  useEffect(async()=>{  
    ...
    setAgree(ethers.utils.formatUnits(balance, 18)); 
  ...
  return (
    <RootStyle>
      ...
      <Typography variant="h3"  color="#000">{fShortenNumber(agree)} {networkId == 28 && "BOBA"  || networkId == 3 &&  "ETH"  || networkId == 97 &&  "BNB"  || networkId == 43113 &&  "AVAX"}</Typography>
